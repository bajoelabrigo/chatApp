...
export function VideoPreviewCard({ reel, size, onPress }: { reel: Reel; size: 'sm' | 'lg'; onPress: () => void }) {
  const isSm = size === 'sm';
  ...
  return (
    <TouchableOpacity
      onPress={onPress}
      activeOpacity={0.85}
      style={{ width: isSm ? 100 : 150, aspectRatio: 9 / 16, borderRadius: 14, overflow: 'hidden', backgroundColor: '#111' }}
    >
